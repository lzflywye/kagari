...
public class ReservationResource {
    ...
    public TemplateInstance getReservationDetails(@PathParam("id") Long id) {
        ...
        // throw new WebApplicationException("Forbidden: You do not have access to this
        // reservation.",
    ...
    public Response confirmReservation(@PathParam("id") Long id) {
        ...
        // if (!reservation.service.tenant.id.equals(tenantId)) {
        // throw new WebApplicationException("Forbidden: You do not have access to
    ...
    // throw new WebApplicationException("Unauthorized: No security context
    // available.",
